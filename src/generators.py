...
def filter_by_currency(transactions: list[dict], currency: str) -> Generator[dict, None, None]:
    """Принимаем список словарей операций - возвращаем операции с заданной валютой."""
...
def transaction_descriptions(transactions):
    """Принимаем список словарей - возвращаем описание каждой операции"""
...
def card_number_generator(start: int, end: int):
    """Генерируем номера карт в формате XXXX XXXX XXXX XXXX."""
